...
ax[0][2].scatter([dist_ts1, dist_ts2], [0, 0], c=cmap(0.), alpha=0.33, s=210, linewidth=3)
ax[0][2].scatter([dist_ts3, dist_ts4], [0, 0], c=cmap(0.75), marker='x', alpha=0.66, s=250, linewidth=3)
...
ax[1][2].scatter([dist_ts1, dist_ts2], [0, 0], c=cmap(0.), alpha=0.33, s=210, linewidth=3)
ax[1][2].scatter([dist_ts3, dist_ts4], [0, 0], c=cmap(0.75), marker='x', alpha=0.66, s=250, linewidth=3)
...
ax[2][2].scatter([dist_ts1, dist_ts2], [0, 0], c=cmap(0.), alpha=0.33, s=210, linewidth=3)
ax[2][2].scatter([dist_ts3, dist_ts4], [0, 0], c=cmap(0.75), marker='x', alpha=0.66, s=250, linewidth=3)
